...
### AI · Copilot · Agentic AI · Community
...
<div id="gh-card-bbfans" style="font-family:system-ui,-apple-system,sans-serif;max-width:400px;border:1px solid #e5e7eb;border-radius:12px;padding:20px;margin:16px 0;background:#fafafa;box-shadow:0 1px 4px rgba(0,0,0,.08)">
  <div style="display:flex;align-items:center;gap:16px;margin-bottom:14px">
    ...
    <div>
      <div style="font-weight:700;font-size:17px;color:#111">@bbfans</div>
      <div style="color:#555;font-size:13px;margin-top:2px">AI is great · Copilot · Agentic AI</div>
      <div style="color:#888;font-size:12px;margin-top:2px">GitHub · 13 yrs</div>
    </div>
  </div>
  ...
  <div style="margin-top:14px;padding-top:10px;border-top:1px solid #e5e7eb;line-height:1.6">
    <span style="font-weight:700;color:#111">94</span><span style="color:#888;font-size:13px"> repositories · </span>
    <span style="font-weight:700;color:#111">13</span><span style="color:#888;font-size:13px"> years · </span>
    <span style="font-weight:700;color:#111">3</span><span style="color:#888;font-size:13px"> followers · </span>
    <span style="font-weight:700;color:#111">9</span><span style="color:#888;font-size:13px"> following</span>
  </div>
</div>
...
<!--
  ...
  profile-card source → logs/profile-card.html
-->
